  ...
  return (
    <AppBar position="sticky" color="primary">
      <Toolbar>
        ...
        {/* <Button color="inherit"><Link to="gallery" smooth={true} duration={500}>Gallery</Link></Button> */}
        <Button color="inherit"><Link to="CarouselGallery" smooth={true} duration={500}>Gallery</Link></Button>
